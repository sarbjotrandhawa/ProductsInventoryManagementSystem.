 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://myservice.com/", wsdlLocation = "http://localhost:8080/Sarbjot_Test1_N01392504/UserServiceService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://myservice.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Sarbjot_Test1_N01392504/UserServiceService?WSDL");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://myservice.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice.com/", "UserServicePort"), UserService.class, features);
    }
